...
#from ipa-deploy.version import __version__
lines = open(here + '/ipa_deploy/version.py', mode='r').readlines()
for line in lines:
...
setuptools.setup(
    ...
    download_url = 'https://github.com/floatinghotpot/ipa-deploy',
    ...
    entry_points={'console_scripts': ['ipa-deploy=ipa_deploy:cli_main']},
